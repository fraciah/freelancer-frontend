...
const BiddingModal = ({ showBiddingModal, setBiddingModal, order, onBidPlaced }) => {
...
export function useBiddingModal(order, onBidPlaced) {
  ...
  const BiddingModalCallback = useCallback(
    ...
    [showBiddingModal, order, onBidPlaced]
  );
